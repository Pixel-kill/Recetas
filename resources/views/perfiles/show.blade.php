...
<div class="container">
            ...
            @foreach ($recetas as $receta)
                <div class="col-md-4 mb-4">
                    <div class="card">
                         ...
                         <div class="card-body">
                            <h3>{{$receta->titulo}}</h3>
                         <a href="{{route('receta.show',['receta'=>$receta->id])}}" class="btn btn-primary d-block mt-4 text-uppercase font-weigth-bold">Ver receta</a>
                         </div>
                    </div>
                </div>
            @endforeach
    ...
    {{-- Esto es para paginar las recetas --}}
