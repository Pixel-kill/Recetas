<a href="{{route('receta.create')}}" class="btn btn-primary mr-2">
...
<a href="{{route('perfil.edit',['perfil'=> Auth::user()->id])}}" class="btn btn-success mr-2">
...
<a href="{{route('perfil.show',['perfil'=> Auth::user()->id])}}" class="btn btn-danger mr-2">
